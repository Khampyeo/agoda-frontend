...
export default function RoomHeaderBar() {
  ...
  return (
    <div className='w-full bg-[#20274d] h-[70px] flex justify-center items-center py-[11px]'>
      ...
      <div className="">
        <button className='flex justify-center items-center w-[100px] bg-[#5392f9] text-white rounded-md  caret-transparent cursor-pointer p-3' onClick={handleClickSearch}>Update</button>
      </div>
    </div>
  )
}
